...
// Fix: Standard client initialization following SDK guidelines.
// Creating a new instance right before use ensures the most reliable connection.
const getAIClient = () => {
...
export const analyzeSentiment = async (text: string) => {
  ...
  // Fix: Property access for response text.
...
export const classifyFeedback = async (feedback: string) => {
  ...
  // Fix: Access .text property and safely parse.
