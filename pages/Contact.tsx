...
import { Send, Github, Linkedin, Instagram, Mail, MessageSquare, MapPin, Globe, AlertTriangle } from 'lucide-react';
...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post('https://formspree.io/f/xbdaobga', formState);
      setIsSent(true);
