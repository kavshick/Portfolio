...
import { Briefcase, GraduationCap, Code2, Cpu, BrainCircuit } from 'lucide-react';
          ...
          <div className="lg:col-span-2 space-y-16">
              ...
              <div className="space-y-8 relative before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-[2px] before:bg-white/5">
                {TIMELINE.map((item, i) => (
                  ...
                  >
                    ...
                    <div className="text-xs font-mono text-cyan-500 uppercase tracking-widest mb-1">{item.year}</div>
            ...
            <section>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {['AI', 'Backend', 'Frontend', 'Tools', 'GameDev'].map((cat) => (
                  <div key={cat} className="glass-panel p-6 rounded-2xl">
                    <h4 className="text-sm font-mono text-cyan-500 uppercase tracking-widest mb-4">{cat}</h4>
          ...
          <div className="space-y-8">
            <div className="glass-panel p-8 rounded-2xl border-cyan-500/10">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex justify-between text-sm">
                  ...
                  <span className="text-white font-medium">Remote / Global</span>
                </li>
                <li className="flex justify-between text-sm">
                  <span className="text-slate-400">Languages</span>
                  <span className="text-white font-medium">Python, TS, C#, JS</span>
                </li>
                <li className="flex justify-between text-sm">
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-cyan-600/20 to-blue-600/20 border border-cyan-500/20">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                I believe that code is only as good as the problem it solves. My philosophy is to build robust, scalable foundations that empower users through intuitive AI integrations.
              </p>
            </div>
          </div>
        </div>
